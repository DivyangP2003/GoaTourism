...
export default function MonumentsDistrictPage() {
      ...
      <div className="relative h-64 overflow-hidden mb-16">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt={`Monuments in ${district.name}`}
            fill
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <h1 className="text-4xl md:text-6xl font-bold text-white tracking-wider drop-shadow-lg text-center">
            MONUMENTS IN {district.name.toUpperCase()}
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {monuments.map((monument) => (
            <Link
              key={monument.id}
              href={`/monuments/${districtSlug}/${monument.slug}`}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {otherDistricts.map((otherDistrict) => (
              <Link
                ...
                href={`/monuments/${otherDistrict.slug}`}
              >
                <div className="group cursor-pointer">
                  {/* District Box */}
