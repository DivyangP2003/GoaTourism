...
export default function MigratedTemplesDistrictPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/temples/migrated-temples">
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="relative h-64 overflow-hidden mb-16">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt={`Migrated Temples in ${district.name}`}
            fill
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <h1 className="text-4xl md:text-6xl font-bold text-white tracking-wider drop-shadow-lg text-center">
            MIGRATED TEMPLES IN {district.name.toUpperCase()}
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-12">
          ...
          <ChevronRight className="h-4 w-4" />
          <Link
            href={`/temples/migrated-temples/${encodeURIComponent(
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {temples.map((temple) => (
            <Link
              key={temple.id}
              href={`/temples/migrated-temples/${districtSlug}/${temple.slug}`}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {otherDistricts.map((otherDistrict) => (
              <Link
                ...
                href={`/temples/migrated-temples/${otherDistrict.slug}`}
              >
                <div className="group cursor-pointer">
                  {/* District Box */}
