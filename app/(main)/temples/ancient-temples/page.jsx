    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-12">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-[#4A6604] font-semibold">Ancient Temples</span>
        </div>

        {/* Information Section */}
        <div className="my-16 bg-white rounded-2xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold text-black mb-6 text-center">
            Explore Ancient Temples by District
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto mb-8">
            Discover the ancient temples of Goa organized by district. Each
            region has its unique architectural styles, historical significance,
            and spiritual heritage. Click on any district to explore the ancient
            temples in that area and learn about their fascinating stories.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {goaDistricts.map((district) => (
            <Link
              key={district.id}
              href={`/temples/ancient-temples/${district.slug}`}
            >
