...
export default function ASISitesDistrictPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-64 overflow-hidden mb-16">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt={`ASI Sites in ${district.name}`}
            fill
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <h1 className="text-4xl md:text-6xl font-bold text-white tracking-wider drop-shadow-lg text-center">
            ASI SITES IN {district.name.toUpperCase()}
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-12">
          ...
          <ChevronRight className="h-4 w-4" />
          <Link
            href={`/archaeological-sites/asi-sites/${encodeURIComponent(district.name.toLowerCase())}`}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {sites.map((site) => (
            <Link key={site.id} href={`/archaeological-sites/asi-sites/${districtSlug}/${site.slug}`}>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {otherDistricts.map((otherDistrict) => (
              <Link key={otherDistrict.id} href={`/archaeological-sites/asi-sites/${otherDistrict.slug}`}>
                <div className="group cursor-pointer">
                  {/* District Box */}
                  <div
                  ...
                  >
                    ...
                    <div className="relative z-10 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      ...
                      <span className="text-sm text-white font-bold">
                        {asiSitesByDistrict[otherDistrict.slug]?.length || 0} ASI Sites
                      </span>
                    </div>
                  </div>
        ...
        <div className="mt-16 text-center pb-16">
          <Link href="/archaeological-sites/asi-sites">
