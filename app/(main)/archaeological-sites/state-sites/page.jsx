...
export default function StateSitesPage() {
  const totalSites = Object.values(stateSitesByDistrict).reduce(
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-12">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-[#4A6604] font-semibold">State Sites</span>
        </div>

        {/* Information Section */}
        <div className="my-16 bg-white rounded-2xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold text-black mb-6 text-center">
            Explore State Protected Sites by District
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto mb-8">
            Discover the Archaeological Survey of India (State) protected sites
            ...
            any district to explore the State sites in that area and learn about
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Total State Protected Sites</p>
            </div>
            <div className="text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {goaDistricts.map((district) => (
            <Link
              key={district.id}
              href={`/archaeological-sites/state-sites/${district.slug}`}
            >
                ...
                >
                  ...
                  <div className="relative z-10 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <span className="text-sm text-white font-bold">
                      {stateSitesByDistrict[district.id]?.length || 0} State Sites
                    </span>
                  </div>
                </div>
